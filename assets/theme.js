...
$("#hcp_video_cover").click(function () {
  $("#hcp_video")[0].src += "?autoplay=1";
});

const hcpPage = document.getElementById('shopify-section-healthcare-professionals');

if (hcpPage) {
  const videoCover = document.getElementById("hcp_video_cover");
  videoCover.onclick = function() {videoClick()};

  function videoClick() {
    const videoCover = document.getElementById("hcp_video_cover");
    videoCover.style.position='fixed';
  }
}
